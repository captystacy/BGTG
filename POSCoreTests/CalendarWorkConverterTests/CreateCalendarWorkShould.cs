...
namespace POSCoreTests.CalendarWorkConverterTests
{
    public class CreateCalendarWorkShould
    {
        ...
        public void NotReturnNull()
        {
            ...
            var calendarWork = _calendarWorkCreator.CreateCalendarWork(estimateWork, DateTime.Today, 0);
        ...
        public void CreateCalendarPeriod()
        {
            ...
            var calendarWork = _calendarWorkCreator.CreateCalendarWork(estimateWork, initialDate, percent1);

            _constructionPeriodCreatorMock.Verify(x => x.CreateConstructionPeriod(initialDate, calendarWork.TotalCost, calendarWork.TotalCostIncludingContructionAndInstallationWorks, new int[] { percent1 }), Times.Once);
        }
    }
}
