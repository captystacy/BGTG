...
{
    public class StepwiseExtrapolationDurationByTCPModelConfiguration : AuditableModelConfigurationBase<StepwiseExtrapolationDurationByTCPEntity>
    {
        protected override void AddBuilder(EntityTypeBuilder<StepwiseExtrapolationDurationByTCPEntity> builder)
        {
            ...
            builder.Property(x => x.StepwiseDuration).HasColumnType("money").IsRequired();
            ...
            builder.HasOne(x => x.StepwisePipelineStandard);
            builder.HasOne(x => x.POS);
        }

        protected override string TableName()
        {
            return "StepwiseExtrapolationDurationByTCPs";
        }
    }
}
