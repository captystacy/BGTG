...
{
    public class DurationByLaborCostsCreatorTests
    {
        private DurationByLaborCostsCreator _durationByLaborCostsCreator;
        ...
        public void SetUp()
        {
            ...
            _durationByLaborCostsCreator = new DurationByLaborCostsCreator(_durationRounder.Object);
        }

        [Test]
        public void Create_004Duration_CreateCorrectDurationByLaborCosts()
        {
            ...
            var expectedDurationByLaborCosts = new POS.DurationLogic.DurationByLaborCosts.DurationByLaborCosts(duration, totalLaborCosts, estimateLaborCosts,
            ...
            var actualDurationByLaborCosts = _durationByLaborCostsCreator.Create(estimateLaborCosts, technologicalLaborCosts, workingDayDuration, shift, numberOfWorkingDaysInMonth, numberOfEmployees, acceptanceTimeIncluded);

            Assert.AreEqual(expectedDurationByLaborCosts, actualDurationByLaborCosts);
        ...
        [Test]
        public void Create_038Duration_CreateCorrectDurationByLaborCosts()
        {
        ...
        [Test]
        public void Create_074Duration_CreateCorrectDurationByLaborCosts()
        {
        ...
        [Test]
        public void Create_354DurationWithTechnologicalLaborCosts_CreateCorrectDurationByLaborCosts()
        {
