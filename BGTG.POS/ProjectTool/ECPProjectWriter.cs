...
namespace BGTG.POS.ProjectTool
{
    public class ECPProjectWriter : IECPProjectWriter
    {
        ...
        public void Write(string objectCipher, DurationByLC durationByLC, DateTime constructionStartDate,
            string durationByLCPath, string calendarPlanPath, string energyAndWaterPath, string templatePath, string savePath)
        {
