...
public class CalendarWorkCreator : ICalendarWorkCreator
{
    ...
    public CalendarWork CreateMainTotalWork(List<CalendarWork> mainCalendarWorks, CalendarWork initialTotalMainWork, DateTime constructionStartDate, int constructionDurationCeiling)
    {
        ...
        return Create(Constants.AppConstants.TotalWorkName, initialTotalMainWork.TotalCost, initialTotalMainWork.TotalCostIncludingCAIW,
        ...
        DateTime constructionStartDate, List<decimal> percentages)
    {
        ...
        return Create(Constants.AppConstants.MainOtherExpensesWorkName, totalCost, totalCostIncludingCAIW, Constants.AppConstants.MainOtherExpensesWorkChapter, constructionStartDate, percentages);
    }
}