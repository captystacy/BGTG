...
{
    private ProjectProvider _projectProvider = null!;
    ...
    public void SetUp()
    {
        ...
        _projectProvider = new ProjectProvider(_ecpProjectWriterMock.Object, _durationByLCServiceMock.Object,
    ...
    public void GetSavePath()
    {
        ...
        var savePath = _projectProvider.GetSavePath();
