...
namespace POS.Tests.Infrastructure.Writers
{
    public class ProjectWriterTests
    {
        ...
        private const string ECPProjectTemplatesDirectory = @"..\..\..\Infrastructure\Templates\ProjectTemplates\ECP\Saiko\Kapitan\Employees4";
        private const string ECPProjectSourcesDirectory = @"..\..\..\Infrastructure\Templates\Source";
