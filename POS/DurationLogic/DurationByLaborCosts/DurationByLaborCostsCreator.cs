...
{
    public class DurationByLaborCostsCreator : IDurationByLaborCostsCreator
    {
        ...
        public DurationByLaborCostsCreator(IDurationRounder durationRounder)
        {
            _durationRounder = durationRounder;
        }

        public DurationByLaborCosts Create(decimal estimateLaborCosts, decimal technologicalLaborCosts, decimal workingDayDuration, decimal shift, decimal numberOfWorkingDaysInMonth, int numberOfEmployees, bool acceptanceTimeIncluded)
        {
            ...
            return new DurationByLaborCosts(decimal.Round(duration, 2), totalLaborCosts, estimateLaborCosts,
