...
{
    public class DurationByLaborCosts : IEquatable<DurationByLaborCosts>
    {
        ...
        public DurationByLaborCosts(decimal duration, decimal totalLaborCosts, decimal estimateLaborCosts, decimal technologicalLaborCosts, decimal workingDayDuration, decimal shift,
            decimal numberOfWorkingDaysInMonth, int numberOfEmployees, decimal totalDuration, decimal preparatoryPeriod, decimal roundedDuration,
        ...
        public bool Equals(DurationByLaborCosts other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
            return Duration == other.Duration && TotalLaborCosts == other.TotalLaborCosts && EstimateLaborCosts == other.EstimateLaborCosts && TechnologicalLaborCosts == other.TechnologicalLaborCosts && WorkingDayDuration == other.WorkingDayDuration && Shift == other.Shift && NumberOfWorkingDays == other.NumberOfWorkingDays && NumberOfEmployees == other.NumberOfEmployees && RoundedDuration == other.RoundedDuration && TotalDuration == other.TotalDuration && PreparatoryPeriod == other.PreparatoryPeriod && AcceptanceTime == other.AcceptanceTime && AcceptanceTimeIncluded == other.AcceptanceTimeIncluded && RoundingIncluded == other.RoundingIncluded;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((DurationByLaborCosts) obj);
        }
        ...
        public static bool operator ==(DurationByLaborCosts left, DurationByLaborCosts right)
        {
